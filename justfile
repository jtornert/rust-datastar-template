...
migrate:
    RUST_LOG=surreal::cli::import=info find sql -type f -name "*.surql" -exec surreal import -e $DB_URL --user $DB_USERNAME --pass $DB_PASSWORD --namespace $DB_NAMESPACE --database $DB_DATABASE {} \;
